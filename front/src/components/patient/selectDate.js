...
const SelectDate = () => {
    ...
    return (
        ...
        <div className="bg-dark container-fluid calendarFluid">
            <div>
                <div className="row m-5 mb-1 pt-5 calendar" >
                        <h3 >Оберіть дату</h3>
