                ...
                <div className="row  ">
                    <div className="col-12 whyWe">
                        ...
                        <ul className="benefits">
                            <li><img src={mind} alt="mind"/><h1>Перевага 1 {/*Продумані схеми реабілітації*/}</h1>
                            ...
                            <li><img src={bed} alt="bed"/><h1>Перевага 2 {/*Умови перебування у центрі*/}</h1>
                                <p> У нашому центрі людина може повною мірою зосередитись на своєму відновленні. 
                                   Тут для кожного пацієнта забезпечується рівень комфорту.</p></li>
                            <li><img src={smile} alt="smile"/><h1>Перевага 3 {/*Комплексний підхід до реабілітації*/}</h1>
                            ...
                            <li><img src={like} alt="like"/><h1>Перевага 4 {/*Високотехнологічне обладнання*/}</h1>
